...
🛠️ 管理功能："""
        ...
        keyboard = [
            ...
            [
                ...
                InlineKeyboardButton("⚙️ 系统设置", callback_data="set_settings")
            ],
            [
                InlineKeyboardButton("🔄 代理同步", callback_data="proxy_sync"),  # 新增
    ...
    async def view_users(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("↩️ 返回", callback_data='user_management')]
        ]
...
发送设置命令..."""
    ...
    async def handle_set_permission(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            ...
            keyboard = [[InlineKeyboardButton("↩️ 返回管理", callback_data='user_management')]]
            reply_markup = InlineKeyboardMarkup(keyboard)
